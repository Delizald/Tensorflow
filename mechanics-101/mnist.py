...
<html lang="en">
  ...
  <title>tensorflow/mnist.py at r1.1 · tensorflow/tensorflow · GitHub</title>
  ...
  <meta name="request-id" content="228E:156C:11AEE6:184AA1:5942E8FE" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="228E:156C:11AEE6:184AA1:5942E8FE" name="octolytics-dimension-request_id" /><meta content="iad" name="octolytics-dimension-region_edge" /><meta content="iad" name="octolytics-dimension-region_render" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="">
    ...
    <meta name="js-proxy-site-detection-payload" content="Yjc0MzUyNTdlM2RmMTY1NzQ2MTM5NjJjNDcxODJhOWI0MTEzZjhiYmExNmYwYjM3NjNlOTc0ZjY2YThkMThjOXx7InJlbW90ZV9hZGRyZXNzIjoiMTQ4LjI0MC4xMTcuNDciLCJyZXF1ZXN0X2lkIjoiMjI4RToxNTZDOjExQUVFNjoxODRBQTE6NTk0MkU4RkUiLCJ0aW1lc3RhbXAiOjE0OTc1NTcyNDYsImhvc3QiOiJnaXRodWIuY29tIn0=">


  <meta name="html-safe-nonce" content="b60276147b461ed51bdc4212a574ddf411195c3a">
  ...
  <meta content="15658638" name="octolytics-dimension-user_id" /><meta content="tensorflow" name="octolytics-dimension-user_login" /><meta content="45717250" name="octolytics-dimension-repository_id" /><meta content="tensorflow/tensorflow" name="octolytics-dimension-repository_nwo" /><meta content="true" name="octolytics-dimension-repository_public" /><meta content="false" name="octolytics-dimension-repository_is_fork" /><meta content="45717250" name="octolytics-dimension-repository_network_root_id" /><meta content="tensorflow/tensorflow" name="octolytics-dimension-repository_network_root_nwo" /><meta content="false" name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" />
    ...
    <link rel="canonical" href="https://github.com/tensorflow/tensorflow/blob/r1.1/tensorflow/examples/tutorials/mnist/mnist.py" data-pjax-transient>
...
<meta name="theme-color" content="#1e2327">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/tensorflow/tensorflow/search" class="js-site-search-form" data-scoped-search-url="/tensorflow/tensorflow/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/tensorflow/tensorflow/blob/r1.1/tensorflow/examples/tutorials/mnist/mnist.py" class="header-search-scope no-underline">This repository</a>
      <input type="text"
        ...
        <input type="hidden" class="js-site-search-type-field" name="type" >
          ...
          <a class="text-bold site-header-link" href="/login?return_to=%2Ftensorflow%2Ftensorflow%2Fblob%2Fr1.1%2Ftensorflow%2Fexamples%2Ftutorials%2Fmnist%2Fmnist.py" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav">
  ...
  <a href="/tensorflow/tensorflow/blob/8ddd727a4a43c0fba11550f3abc277a6e8d9f8c0/tensorflow/examples/tutorials/mnist/mnist.py" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:908000f0b79a9e6684bfec457c8cb5b0 -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/tensorflow/tensorflow/blob/r0.12/tensorflow/examples/tutorials/mnist/mnist.py"
               data-name="r0.12"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/tensorflow/tensorflow/blob/r1.0/tensorflow/examples/tutorials/mnist/mnist.py"
               data-name="r1.0"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/tensorflow/tensorflow/blob/r1.1/tensorflow/examples/tutorials/mnist/mnist.py"
               data-name="r1.1"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/tensorflow/tensorflow/blob/r1.2/tensorflow/examples/tutorials/mnist/mnist.py"
               data-name="r1.2"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/tensorflow/tensorflow/blob/revert-10411-branch_157903115/tensorflow/examples/tutorials/mnist/mnist.py"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.2.0-rc2/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.2.0-rc1/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.2.0-rc0/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.1.0/tensorflow/examples/tutorials/mnist/mnist.py"
              data-name="v1.1.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.1.0-rc2/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.1.0-rc1/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.1.0-rc0/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.0.1/tensorflow/examples/tutorials/mnist/mnist.py"
              data-name="v1.0.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.0.0/tensorflow/examples/tutorials/mnist/mnist.py"
              data-name="v1.0.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.0.0-rc2/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.0.0-rc1/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.0.0-rc0/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v1.0.0-alpha/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/v0.12.0/tensorflow/examples/tutorials/mnist/mnist.py"
              data-name="v0.12.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/0.12.1/tensorflow/examples/tutorials/mnist/mnist.py"
              data-name="0.12.1"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/0.12.0-rc1/tensorflow/examples/tutorials/mnist/mnist.py"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/tensorflow/tensorflow/tree/0.12.0-rc0/tensorflow/examples/tutorials/mnist/mnist.py"
...
Change: 143629623">Change arg order for {softmax,sparse_softmax,sigmoid}_cross_entropy_w…</a>
    ...
    <a class="avatar-link tooltipped tooltipped-s" aria-label="martinwicke" href="/tensorflow/tensorflow/commits/master/tensorflow/examples/tutorials/mnist/mnist.py?author=martinwicke"><img alt="@martinwicke" class="avatar" height="20" src="https://avatars2.githubusercontent.com/u/577277?v=3&amp;s=40" width="20" /> </a>
    ...
    <a class="avatar-link tooltipped tooltipped-s" aria-label="dandelionmane" href="/tensorflow/tensorflow/commits/master/tensorflow/examples/tutorials/mnist/mnist.py?author=dandelionmane"><img alt="@dandelionmane" class="avatar" height="20" src="https://avatars3.githubusercontent.com/u/1400023?v=3&amp;s=40" width="20" /> </a>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/tensorflow/tensorflow/raw/r1.1/tensorflow/examples/tutorials/mnist/mnist.py" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/tensorflow/tensorflow/blame/r1.1/tensorflow/examples/tutorials/mnist/mnist.py" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/tensorflow/tensorflow/commits/r1.1/tensorflow/examples/tutorials/mnist/mnist.py" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code blob-code-inner js-file-line"><span class="pl-k">from</span> <span class="pl-c1">__future__</span> <span class="pl-k">import</span> absolute_import</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC31" class="blob-code blob-code-inner js-file-line"><span class="pl-k">from</span> <span class="pl-c1">__future__</span> <span class="pl-k">import</span> print_function</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC37" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> The MNIST dataset has 10 classes, representing the digits 0 through 9.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC40" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span> The MNIST images are always 28x28 pixels.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC56" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Hidden 1</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC65" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Hidden 2</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC74" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Linear</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC98" class="blob-code blob-code-inner js-file-line">      <span class="pl-v">labels</span><span class="pl-k">=</span>labels, <span class="pl-v">logits</span><span class="pl-k">=</span>logits, <span class="pl-v">name</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&#39;</span>xentropy<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
        <td id="L99" class="blob-num js-line-number" data-line-number="99"></td>
        <td id="LC99" class="blob-code blob-code-inner js-file-line">  <span class="pl-k">return</span> tf.reduce_mean(cross_entropy, <span class="pl-v">name</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&#39;</span>xentropy_mean<span class="pl-pds">&#39;</span></span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC102" class="blob-code blob-code-inner js-file-line"><span class="pl-k">def</span> <span class="pl-en">training</span>(<span class="pl-smi">loss</span>, <span class="pl-smi">learning_rate</span>):</td>
      </tr>
      <tr>
        <td id="L103" class="blob-num js-line-number" data-line-number="103"></td>
        <td id="LC103" class="blob-code blob-code-inner js-file-line">  <span class="pl-s"><span class="pl-pds">&quot;&quot;&quot;</span>Sets up the training Ops.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC105" class="blob-code blob-code-inner js-file-line"><span class="pl-s">  Creates a summarizer to track the loss over time in TensorBoard.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC107" class="blob-code blob-code-inner js-file-line"><span class="pl-s">  Creates an optimizer and applies the gradients to all trainable variables.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC109" class="blob-code blob-code-inner js-file-line"><span class="pl-s">  The Op returned by this function is what must be passed to the</span></td>
      </tr>
      <tr>
        <td id="L110" class="blob-num js-line-number" data-line-number="110"></td>
        <td id="LC110" class="blob-code blob-code-inner js-file-line"><span class="pl-s">  `sess.run()` call to cause the model to train.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC113" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    loss: Loss tensor, from loss().</span></td>
      </tr>
      <tr>
        <td id="L114" class="blob-num js-line-number" data-line-number="114"></td>
        <td id="LC114" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    learning_rate: The learning rate to use for gradient descent.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC117" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    train_op: The Op for training.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC119" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Add a scalar summary for the snapshot loss.</span></td>
      </tr>
      <tr>
        <td id="L120" class="blob-num js-line-number" data-line-number="120"></td>
        <td id="LC120" class="blob-code blob-code-inner js-file-line">  tf.summary.scalar(<span class="pl-s"><span class="pl-pds">&#39;</span>loss<span class="pl-pds">&#39;</span></span>, loss)</td>
      </tr>
      <tr>
        <td id="L121" class="blob-num js-line-number" data-line-number="121"></td>
        <td id="LC121" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Create the gradient descent optimizer with the given learning rate.</span></td>
      </tr>
      <tr>
        <td id="L122" class="blob-num js-line-number" data-line-number="122"></td>
        <td id="LC122" class="blob-code blob-code-inner js-file-line">  optimizer <span class="pl-k">=</span> tf.train.GradientDescentOptimizer(learning_rate)</td>
      </tr>
      <tr>
        <td id="L123" class="blob-num js-line-number" data-line-number="123"></td>
        <td id="LC123" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Create a variable to track the global step.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC125" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Use the optimizer to apply the gradients that minimize the loss</span></td>
      </tr>
      <tr>
        <td id="L126" class="blob-num js-line-number" data-line-number="126"></td>
        <td id="LC126" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> (and also increment the global step counter) as a single training step.</span></td>
      </tr>
      <tr>
        <td id="L127" class="blob-num js-line-number" data-line-number="127"></td>
        <td id="LC127" class="blob-code blob-code-inner js-file-line">  train_op <span class="pl-k">=</span> optimizer.minimize(loss, <span class="pl-v">global_step</span><span class="pl-k">=</span>global_step)</td>
      </tr>
      <tr>
        <td id="L128" class="blob-num js-line-number" data-line-number="128"></td>
        <td id="LC128" class="blob-code blob-code-inner js-file-line">  <span class="pl-k">return</span> train_op</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC131" class="blob-code blob-code-inner js-file-line"><span class="pl-k">def</span> <span class="pl-en">evaluation</span>(<span class="pl-smi">logits</span>, <span class="pl-smi">labels</span>):</td>
      </tr>
      <tr>
        <td id="L132" class="blob-num js-line-number" data-line-number="132"></td>
        <td id="LC132" class="blob-code blob-code-inner js-file-line">  <span class="pl-s"><span class="pl-pds">&quot;&quot;&quot;</span>Evaluate the quality of the logits at predicting the label.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC135" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    logits: Logits tensor, float - [batch_size, NUM_CLASSES].</span></td>
      </tr>
      <tr>
        <td id="L136" class="blob-num js-line-number" data-line-number="136"></td>
        <td id="LC136" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    labels: Labels tensor, int32 - [batch_size], with values in the</span></td>
      </tr>
      <tr>
        <td id="L137" class="blob-num js-line-number" data-line-number="137"></td>
        <td id="LC137" class="blob-code blob-code-inner js-file-line"><span class="pl-s">      range [0, NUM_CLASSES).</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC140" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    A scalar int32 tensor with the number of examples (out of batch_size)</span></td>
      </tr>
      <tr>
        <td id="L141" class="blob-num js-line-number" data-line-number="141"></td>
        <td id="LC141" class="blob-code blob-code-inner js-file-line"><span class="pl-s">    that were predicted correctly.</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC143" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> For a classifier model, we can use the in_top_k Op.</span></td>
      </tr>
      <tr>
        <td id="L144" class="blob-num js-line-number" data-line-number="144"></td>
        <td id="LC144" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> It returns a bool tensor with shape [batch_size] that is true for</span></td>
      </tr>
      <tr>
        <td id="L145" class="blob-num js-line-number" data-line-number="145"></td>
        <td id="LC145" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> the examples where the label is in the top k (here k=1)</span></td>
      </tr>
      <tr>
        <td id="L146" class="blob-num js-line-number" data-line-number="146"></td>
        <td id="LC146" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> of all logits for that example.</span></td>
      </tr>
      <tr>
        <td id="L147" class="blob-num js-line-number" data-line-number="147"></td>
        <td id="LC147" class="blob-code blob-code-inner js-file-line">  correct <span class="pl-k">=</span> tf.nn.in_top_k(logits, labels, <span class="pl-c1">1</span>)</td>
      </tr>
      <tr>
        <td id="L148" class="blob-num js-line-number" data-line-number="148"></td>
        <td id="LC148" class="blob-code blob-code-inner js-file-line">  <span class="pl-c"><span class="pl-c">#</span> Return the number of true entries.</span></td>
      </tr>
      <tr>
        <td id="L149" class="blob-num js-line-number" data-line-number="149"></td>
        <td id="LC149" class="blob-code blob-code-inner js-file-line">  <span class="pl-k">return</span> tf.reduce_sum(tf.cast(correct, tf.int32))</td>
      </tr>
</table>
...
<div class="container site-footer-container">
  <div class="site-footer " role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.14851s from github-fe130-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
